    ...
    <div class="container-fluid padding-top-100 bg-white">
      <div class="row justify-content-between width_article mx-auto d-none d-lg-flex">
        <div class="col-4 border mr-4 rounded-4 me-4 article_small padding-19 position-relative bg-white">
            ...
            <div class="row">
              <div class="col-5 color-2 margin_left"><?= $article[0]['about']?></div>
            ...
            <div class="row">
              <div class="col-5">
                ...
                <div class="col article-2-text ">
                      ...
                      <div class="row">
                        <div class="col-5 color-1 margin_left"><?= $article[1]['about'] ?></div>
      ...
      <div class="row justify-content-between width_article mx-auto d-none d-lg-flex">
        <div class="col border mt-4 rounded-4 article_big me-4 padding-19 position-relative bg-white">
              ...
              <div class="row"><div class="col-5 color-3 margin_left"><?= $article[2]['about'] ?></div>
        ...
        <div class="col-5 border mt-4 rounded-4 article_small padding-19 position-relative bg-white">
              ...
              <div class="row"><div class="col-5 color-4 margin_left"><?= $article[3]['about'] ?></div>
                ...
                <div class="modal-content mx-md-3 rounded-4">
                  ...
                  <div class="row mt-md-5 justify-content-between p-5 ps-5 text-start">
                      <div class="col-12 col-md-2 font-600">
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="http://localhost:8765/homes/?locale=vi_VN">Tiếng Việt</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="http://localhost:8765/homes/?locale=en_US">English</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="http://localhost:8765/homes/?locale=es">Español</a><br>
                      </div>
                      <div class="col-12 col-md-2 font-600 text-start">
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Français</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Nederlands</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Polski</a><br>
                      </div>
                      <div class="col-12 col-md-2 font-600 text-start">
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Português</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Русский</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Bokmål</a><br>
                      </div>
                      <div class="col-12 col-md-2 font-600 text-start">
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">Ελληνικά</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">日本語繁</a><br>
                        <a class="text-black text-decoration-none mt-3 border rounded-3" href="">體中文</a><br>
                      </div>
                  </div>
